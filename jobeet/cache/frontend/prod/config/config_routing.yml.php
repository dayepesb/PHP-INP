...
// date: 2018/01/26 22:06:41
return array(
'new_post' => new sfRoute('/new/post', array (
  'module' => 'job',
  'action' => 'newPost',
), array (
), array (
)),
'delete_job_post' => new sfRoute('/job/delete', array (
  'module' => 'job',
  'action' => 'jobDelete',
), array (
), array (
)),
'job_json' => new sfRoute('/job/json', array (
  'module' => 'job',
  'action' => 'json',
), array (
), array (
)),
'category_job_json' => new sfRoute('/category/job/json', array (
  'module' => 'job',
  'action' => 'categoryJob',
), array (
), array (
)),
'job_view_json' => new sfRoute('/job/view/json', array (
  'module' => 'job',
  'action' => 'jobView',
), array (
), array (
)),
'job_category_json' => new sfRoute('/job/category/json', array (
  'module' => 'job',
  'action' => 'jsonCategory',
), array (
), array (
